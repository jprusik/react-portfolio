...
export default function SocialLinks(props) {
  ...
  const stackOverflowLink = stackOverflow && <ExternalDomainLink key="stack-overflow-link" className="stack-overflow-link" href={stackOverflow}><FontAwesomeIcon icon={faStackOverflow} />Stack Overflow</ExternalDomainLink>;
  const linkedInLink = linkedInHandle && <ExternalDomainLink key="linkedin-link" className="linkedin-link" href={`https://www.linkedin.com/in/${linkedInHandle}`}><FontAwesomeIcon icon={faLinkedin} />LinkedIn</ExternalDomainLink>;
